...
<div class="row" style="margin-top: 100px;">
    <h1 align="center" style="margin-bottom: 50px; font-family: '微软雅黑';">选择学科添加面试信息</h1>
    <div class="col-md-2"></div>
    <div class="col-md-2 selectXueke" data="java">
        <a href="?r=interview/add&type=java" target="_blank">
    ...
    <div class="col-md-2 selectXueke" data="php">
        <a href="?r=interview/add&type=php" target="_blank">
    ...
    <div class="col-md-2 selectXueke" data="ui">
        <a href="?r=interview/add&type=ui" target="_blank">
    ...
    <div class="col-md-2 selectXueke" data="web">
        <a href="?r=interview/add&type=web" target="_blank">
